...
def player_states(player: Entity, console: tcod.console.Console) -> None:
	...
	view_x = ui.STATE_PORT_X
	view_y = ui.STATE_PORT_Y
	view_width = ui.STATE_PORT_WIDTH
...
#	logger.debug(view_port)
	...
	console.print(x=ui.WORLD_PORT_X, y=ui.WORLD_PORT_Y, text=f"{current_map['name']}", fg=colours.bar_text)
